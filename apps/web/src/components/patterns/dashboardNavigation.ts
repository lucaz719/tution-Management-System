...
export const DASHBOARD_NAVIGATION: Record<DashboardRole, DashboardNavItem[]> = {
  ...
  'tenant-admin': [
    ...
    { section: 'Finance', label: 'Payroll', icon: 'account_balance_wallet', path: '/tenant/payroll', phase: 3 },
    { section: 'Finance', label: 'Petty Cash', icon: 'savings', path: '/tenant/petty-cash', phase: 3 },
    { section: 'Finance', label: 'P&L Reports', icon: 'monitoring', path: '/tenant/pl-reports', phase: 3 },
    { section: 'Operations', label: 'Leave Management', icon: 'event_busy', path: '/tenant/leave-management' },
  ...
  student: [
    { section: 'Student', label: 'Home', icon: 'home', path: '/student/home' },
    { section: 'Student', label: 'Timetable', icon: 'calendar_today', path: '/student/timetable' },
    { section: 'Student', label: 'Fees', icon: 'payments', path: '/student/fees' },
    { section: 'Student', label: 'Digital ID', icon: 'badge', path: '/student/digital-id' },
    { section: 'Student', label: 'Homework', icon: 'assignment', path: '/student/homework', phase: 2 },
    { section: 'Student', label: 'Results', icon: 'analytics', path: '/student/results', phase: 2 },
  ],
  parent: [
